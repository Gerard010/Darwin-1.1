...
conversational_responses = {
    ...
    "what can you do": "I can assist with tasks, answer questions, and more!",
    ...
    "what day is it": "Today is {current_day}.",
    
    "how old are you": "I don’t age, but I’m always learning!",
...
def execute_command():
    ...
    if re.match(r'https?://(?:[-\w.]|(?:%[\da-fA-F]{2}))+', command):
        ...
        response = "Cleared input field."
    
    elif command in conversational_responses:
        response = conversational_responses[command]
...
button_open_notepad = tk.Button(button_frame, text="Notepad", command=lambda: os.system("open -a TextEdit"))
